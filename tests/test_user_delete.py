...
class TestUserDelete(BaseCase):
    ...
    @allure.description("Ensures the system prevents deletion of user ID 2")
    @allure.tag("negative")
    ...
    @allure.severity(allure.severity_level.NORMAL)
    @allure.description("Verifies deleting a newly created user")
    @allure.tag("smoke")
    def test_delete_user_positive(self):
        ...
        assert error_message == "User not found", f"Expected 'User not found', got '{error_message}'"

    @allure.severity(allure.severity_level.NORMAL)
    @allure.description("Ensures a user cannot delete another user's account")
    @allure.tag("negative")
